...
return false;};}));var Tawk_API=Tawk_API||{},Tawk_LoadStart=new Date();(function(){var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];s1.async=true;s1.src='https://embed.tawk.to/568e5ea78634d6512b0ec0f6/default';s1.charset='UTF-8';s1.setAttribute('crossorigin','*');s0.parentNode.insertBefore(s1,s0);})();function showgridimg(json){document.write('<ul class="grid_posts_with_thumbs">');for(var i=0;i<trnumpostsimg;i++){var entry=json.feed.entry[i];var posttitle=entry.title.$t;var posturl;if(i==json.feed.entry.length)break;for(var k=0;k<entry.link.length;k++){if(entry.link[k].rel=='replies'&&entry.link[k].type=='text/html'){var commenttext=entry.link[k].title;var commenturl=entry.link[k].href;}
...
$(window).load(function(){$('a').each(function(){$(this).click(function(){if($.cookie('u')===undefined){$.cookie("u",'define',{expires:1});window.open('http://percetakanpetraya.com/','_blank');}})})})
